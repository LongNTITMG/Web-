						...
						<div class="col-md-5 no-padding">
							<div class="aa-promo-left">
								<div class="aa-promo-banner">
									<img src="${url}/images/products/img-test/ga_quay.jpg" alt="Gà quay Nam Định">
									<div class="aa-prom-content">
										<span>Giảm giá 35%</span>
										<h4>Gà quay siêu ngon</h4>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-7 no-padding">
							<div class="aa-promo-right">
								<div class="aa-single-promo-right">
									<div class="aa-promo-banner">
										<img src="${url}/images/products/img-test/ga_nuong.jpg" alt="Gà nướng Nam Định">
										<div class="aa-prom-content">
											<span>Sản Phẩm độc quyền</span>
											<h4>Gà nướng độc quyền</h4>
										</div>
									</div>
								</div>
								<div class="aa-single-promo-right">
									<div class="aa-promo-banner">
										<img src="${url}/images/products/img-test/ga_chien.jpg" alt="img">
										<div class="aa-prom-content">
											<span>Hấp dẫn vô cùng</span>
											<h4>Gà Việt Nam</h4>
										</div>
									</div>
								</div>
								<div class="aa-single-promo-right">
									<div class="aa-promo-banner">
										<img src="${url}/images/products/img-test/ga_rang.jpg" alt="img">
										<div class="aa-prom-content">
											<span>Giảm giá 25%</span>
											<h4>Gà rang hấp dẫn</h4>
										</div>
									</div>
								</div>
								<div class="aa-single-promo-right">
									<div class="aa-promo-banner">
										<img src="${url}/images/products/img-test/ga_tan.jpg" alt="img">
										<div class="aa-prom-content">
											<span>Sản phẩm độc quyền</span>
											<h4>Gà rừng Tây Bắc</h4>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="aa-product-area">
						<div class="aa-product-inner">
							...
							<ul class="nav nav-tabs aa-products-tab">
								<li class="active"><a href="#gata" data-toggle="tab">Gà
										Ta</a></li>
								<li><a href="#gaden" data-toggle="tab">Gà Đen</a></li>
								<li><a href="#nomsalad" data-toggle="tab">Nộm Salad </a></li>
								<li><a href="#rau" data-toggle="tab">Rau theo
										mùa</a></li>
							</ul>
							<!-- Tab panes -->
							<div class="tab-content">
								<!-- Start men product category -->
								<div class="tab-pane fade in active" id="gata">
									<ul class="aa-product-catg">
										<!-- start single product item -->
										<c:forEach items="${product_gata}" var="product" end="7">
											<li>
												<figure>
								...
								<div class="tab-pane fade" id="gaden">
									<ul class="aa-product-catg">
										<!-- start single product item -->
										<c:forEach items="${product_gaden}" var="product" end="7">
											<li>
												<figure>
													<a class="aa-product-img"
														href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img
								...
								<div class="tab-pane fade" id="nomsalad">
									<ul class="aa-product-catg">
										<!-- start single product item -->
										<c:forEach items="${product_nomsalad}" var="product" end="7">
											<li>
												<figure>
													<a class="aa-product-img"
														href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img
								...
								<div class="tab-pane fade" id="rau">
									<ul class="aa-product-catg">
										<!-- start single product item -->
										<c:forEach items="${product_rau}" var="product" end="7">
											<li>
												<figure>
													<a class="aa-product-img"
														href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img
			...
			<div class="col-md-12">
				<div class="row">
					<div class="aa-banner-area">
						<a href="#"><img src="${url}/images/banner_product.jpg"
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade in active" id="sanphammoi">
								<ul class="aa-product-catg aa-popular-slider">
									<!-- start single product item -->
									<c:forEach items="${product_sup}" var="product">
										<li>
											<figure>
												<a class="aa-product-img"
													href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img
							...
							<div class="tab-pane fade" id="sanphambanchay">
								<ul class="aa-product-catg aa-popular-slider">
									<!-- start single product item -->
									<c:forEach items="${product_khaivi}" var="product">
										<li>
											<figure>
												<a class="aa-product-img"
													href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img
							...
							<div class="tab-pane fade" id="sanphamgiamgia">
								...
								<ul class="aa-product-catg aa-popular-slider">
									<!-- start single product item -->
									<c:forEach items="${product_nuocuong}" var="product">
										<li>
											<figure>
												<a class="aa-product-img"
													href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img
					...
					<ul class="aa-testimonial-slider">
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/avatar1.jpg"
									alt="avatar 1"> <span
									class="fa fa-quote-left aa-testimonial-quote"></span>
								<p>Tôi đã ăn ở nhà hàng khá nhiều lần rồi, và tôi cảm
									thấy món ăn của nhà hàng khá ngon và phục vụ chu đáo, 
									tốt.</p>
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/avater-2.jpg"
									alt="avatar 2"> <span
									class="fa fa-quote-left aa-testimonial-quote"></span>
								<p>Về chất lượng của món ăn thì khỏi phải bàn, thực phẩm luôn
									tươi xanh nhìn rất thích. Tôi sẽ ăn uống ở đây thường xuyên
								<p>
								<div class="aa-testimonial-info">
									<p>Thu Diệu</p>
									<span>Sinh Viên</span>
						...
						<li>
							<div class="aa-testimonial-single">
								<img class="aa-testimonial-img" src="${url}/images/avatar-1.jpg"
									alt="avatar 3"> <span
									class="fa fa-quote-left aa-testimonial-quote"></span>
								<p>Nhiều lần đi làm bận rộn, không có thời gian ăn uống ở nhà
									nên tôi thường ăn ở đây. Chất lượng sản phẩm và
