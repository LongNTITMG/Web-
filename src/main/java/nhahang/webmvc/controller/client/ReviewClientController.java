...
import nhahang.webmvc.model.Review;
import nhahang.webmvc.service.ReviewService;
import nhahang.webmvc.service.impl.ReviewServicesImpl;
...
public class ReviewClientController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher dispatcher = req.getRequestDispatcher(
				req.getContextPath() + "/view/client/product-detail?id=" + req.getParameter("id"));
