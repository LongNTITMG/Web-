...
import nhahang.webmvc.dao.impl.RegisterDao;
import nhahang.webmvc.jdbc.connectDB;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (register.RegisterUser(user)) // On success, you can display a message to user on Home page
		{
			request.setAttribute("Message",
					"Bạn đã tạo tài khoàn thành công. Mời bạn đăng nhập <a href='/NhaHang/view/client/login'>tại đây!</a>");
